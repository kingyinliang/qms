...
// 查人员
export function USER_LIST_QUERY (params = {}):Promise<AxiosResponse> {
  return Http.post('/sysUser/userRole/all/query', params, { baseURL: (process.env.VUE_APP_SYSTEM_API as string) + (process.env.VUE_APP_API_V as string) })
}
// 组织架构-按工厂和类型查询组织机构
